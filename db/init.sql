...
INSERT INTO locations
    (name, address, state, description, rating)
VALUES
    ...
    ('Mount Rainier', 'Mount Rainier', 'WA', "This active 14,411-ft. volcano & scenic hiking destination is the Cascade Range's highest mountain", 3),
